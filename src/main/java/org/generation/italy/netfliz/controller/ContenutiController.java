...
public class ContenutiController {
	...
	public String elencoContenuti(
		...
		if (titolo == null && genere == null && tipologia == null && anno == null)
			...
			elencoContenuti = (ArrayList<Contenuto>) contenutiRepository.findByTitoloLike("%" + titolo + "%"); // Ricerca
																												// tramite
																												// parola
																												// chiave
		else if (titolo == null && genere != null && tipologia == null && anno == null)
			...
			elencoContenuti = (ArrayList<Contenuto>) contenutiRepository.findByAnnoBetween(annoInizio, annoFine); // ricerca
																													// tramite
																													// intervallo
																													// di
																													// anni
		...
		if (ordinamento != null) {
			if (ordinamento.equals("asc"))
				...
				Collections.sort(elencoContenuti, Collections.reverseOrder()); // ordinamento predefinito (tramite nome)
